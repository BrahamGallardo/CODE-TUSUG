...
public class GUIReporteManten {
    ...
    public void valida() {
        ...
        txt_costo.addKeyListener(len20);
        txt_costo.addKeyListener(Validador.KEYonlyNumbers);
        //txt_matricula.addKeyListener(len20);
        //txt_tipoManten.addKeyListener(len20);
        txt_direccion.addKeyListener(len40);
        txt_telefono.addKeyListener(len10);
        txt_telefono.addKeyListener(Validador.KEYonlyNumbers);
                    ...
                    try {
                        if (validaIngreso(txt_areaTrabajo, txt_costo, txt_direccion, txt_telefono, txt_email)
                            ...
                            if (Validador.emailValido(txt_email.getText())) {
                                if (new java.util.Date().getTime() > calendario.getDate().getTime()) {
                                    throw new Exception("La fecha esta mal");
                                }
                                try {
                        ...
                        JOptionPane.showMessageDialog(null, "Fecha invalida por ser anterior a la actual");
                    }
