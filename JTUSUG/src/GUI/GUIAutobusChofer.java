...
public class GUIAutobusChofer {
    ...
    ActionListener listener = new ActionListener(){
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            switch(op){
                case "regresar": x.dispose(); break;
                case "Actualizar": //Code Here:
                    break;
            }
        }
    ...
    public GUIAutobusChofer() {
        ...
        //Menu
        /**
         * barra=new JMenuBar(); barra.setBackground(Color.GRAY); archivo=new
         * JMenu(user); reestablecer = new JMenuItem("Reestablecer Contraseña");
         * Cerrar_Sesion= new JMenuItem("Cerrar Sesión");
         * archivo.add(reestablecer); archivo.add(Cerrar_Sesion);
         * barra.add(archivo); p.add(barra); barra.setBounds(new
         * Rectangle(478,518,55,34)); barra.setVisible(true);
         */
        //botones
